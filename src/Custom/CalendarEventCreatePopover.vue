...
<script>
import { CalendarEvent, Calendar, Pattern, Functions as fn, colors as dsColors } from 'dayspan';
...
export default {
  ...
  watch: {
    title() {
      ...
      const hexColor = _.filter(this.$dayspan.colors, c => c.text.toLowerCase() === color)[0].value;
