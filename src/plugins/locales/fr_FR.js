export default {
  ...
  openInvitation: 'Invitation publique',
  shareLinkText: 'Partagez le lien suivant pour inviter n\'importe qui à participer à cette étude.',
  deleteOpenInvitation: 'Supprimer l\'invitation publique',
  deleteOpenInvitationText: 'Supprimer cette invitation ne permet plus à personne de s\'inviter pour cette étude. Les utilisateurs qui se sont déjà invités, mais qui ont une invitation en attente, peuvent toujours la rejoindre.',
  createOpenLink: 'Créez un lien publique',
  createOpenLinkText: 'Générez un lien qui permettra à n\'importe qui de s\'inviter à cette étude.',
  id: 'Identifiant',
