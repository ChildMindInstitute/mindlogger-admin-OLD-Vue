export default {
  ...
  useSecretIdSelector: `Sélecteur d'identifiants secrets`,
  searchCases: `Recherche de cas`,
  newCase: 'Nouveau cas',
  caseId: 'Identifiant du cas',
  actions: 'Actions',
  cases: 'Cas',
  viewCase: 'Afficher le cas',
  deleteCase: 'Supprimer un cas',
  caseUpdateSuccess: `Votre cas {name} a été mis à jour avec succès`,
  caseUpdate: `Mise à jour du cas`,
  caseFailed: 'Échec de la création du cas',
  caseCreateSuccess: 'Votre cas {name} a été créé avec succès',
  caseSuccess: 'Création de cas réussie',
  caseAlreadyExists: `Impossible de créer un nouveau cas avec l'identifiant spécifié.`,
  confirmDeleteCase: `Êtes-vous sûr de vouloir supprimer le cas {name} ?`,
  caseDeleteSuccess: `Votre cas {name} a été supprimé correctement.`,
  entries: 'Saisies',
  linkUser: 'Lier un utilisateur',
  selectAll: `Sélectionner tout`,
  link: 'Lier',
  unlink: 'Détacher',
  selectUser: 'Veuillez sélectionner un utilisateur',
  selectUserAndApplets: 'Veuillez sélectionner un utilisateur et des applets',
  failedToLink: 'Échec de la liaison',
  failedToUnlink: 'Échec du détachement',
  casePassword: 'Mot de passe du cas',
  incorrectCasePassword: 'Mot de passe du cas incorrect',
  searchEntries: 'Rechercher des saisies',
  newEntry: 'Nouvelle saisie',
  responderId: 'Identifiant du répondant',
  lastUpdated: 'Dernière mise à jour',
  status: 'Statut',
  selectAppletForNewEntry: `Veuillez sélectionner l'applet pour laquelle vous souhaitez créer une nouvelle saisie :`,
  newEntryTitle: `Nouvelle saisie pour le cas {name}`,
  selectEntryType: `Veuillez sélectionner la façon dont l'évaluation est effectuée`,
  selfReportText: 'Démarrer et faire un rapport sur la webapp moi-même',
  oneTimeReportText: 'Envoi unique',
  oneTimeReportEntry: 'Saisie de soumission unique',
  linkedUserText: 'Utilisateur lié',
  selectLinkedUser: `Veuillez sélectionner un utilisateur lié`,
  entryType: 'Type de saisie',
  createEntry: 'Créer une saisie',
  confirmDeleteEntry: 'Êtes-vous sûr de vouloir supprimer cette saisie ?',
  deleteEntry: 'Supprimer la saisie',
  entryDeleted: 'Votre saisie a été supprimée avec succès',
  createFailed: 'Échec de la création',
  createEntryFailedText: 'Impossible de créer une saisie',
  selectAppletsForUser: 'Veuillez sélectionner les applets',
  selectAppletsForCase: 'Veuillez sélectionner les applets à ajouter au cas.',
  createCaseId: `Créer l'ID du cas`,
  selectApplets: 'Sélectionnez les applets',
  shareLinkForCaseAssessment: `Partagez le lien suivant pour que les utilisateurs puissent suivre l'évaluation`,
  scheduleUpdated: `L'agenda de {MRN} a été mis à jour`,
  linkAccountWithNewCase: `Merci, nous avons enregistré votre cas. Cet identifiant de cas ({caseId}) correspond à l'identifiant secret d'un utilisateur. Voulez-vous lier ce compte avec l'identifiant de cas nouvellement créé ?`,
  selectResponseToReview: `Veuillez sélectionner une réponse à examiner`
};
