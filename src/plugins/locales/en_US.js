export default {
  ...
  publishAppletConfirmation: 'Are you sure you want to add applet to all mindlogger users?',
  publishAppletSuccess: 'Your applet is published successfully',
  concealAppletConfirmation: 'Are you sure you want to conceal this applet?',
  ...
  all: 'All',
  userDataUpdate: 'User Data Update',
  userDataUpdateSuccess: 'User data is updated successfully.',
  ...
  caseUpdateSuccess: 'Your case {name} has been updated successfully',
  caseUpdate: 'Case Update',
  caseFailed: 'Create Case Failed',
  caseCreateSuccess: 'Your case {name} has been created successfully',
  caseSuccess: 'Create Case Success',
  caseAlreadyExists: 'Unable to create a new case with specified id',
  confirmDeleteCase: 'Are you sure you want to delete case {name}?',
  caseDeleteSuccess: 'Your case {name} has been deleted successfully',
  entries: 'Entries',
  linkUser: 'Link User',
  ...
  selectUserAndApplets: 'Please select user and applets',
  failedToLink: 'Failed to Link',
  failedToUnlink: 'Failed to Unlink',
  casePassword: 'Case Password',
  incorrectCasePassword: 'Incorrect case password',
  searchEntries: 'Search Entries',
  newEntry: 'New Entry',
  responderId: 'Responder Id',
  lastUpdated: 'Last Updated',
  status: 'Status',
  selectAppletForNewEntry: 'Please select the applet to create a new entry for:',
  newEntryTitle: 'New Entry for Case {name}',
  selectEntryType: 'Please select the way an assessment is taken',
  selfReportText: 'Launch and report on webapp myself',
  oneTimeReportText: 'One-time submission',
  oneTimeReportEntry: 'One-time submission entry',
  linkedUserText: 'Linked User',
  selectLinkedUser: 'Please select a linked user',
  entryType: 'Entry Type',
  createEntry: 'Create Entry',
  confirmDeleteEntry: 'Are you sure you want to delete this entry?',
  deleteEntry: 'Delete Entry',
  entryDeleted: 'Your entry has been deleted successfully',
  createFailed: 'Failed to Create',
  createEntryFailedText: 'Unable to create an entry',
  selectAppletsForUser: 'Please Select Applets',
  selectAppletsForCase: 'Please Select Applets to Add to Case',
  createCaseId: 'Create CaseID',
  selectApplets: 'Select Applets',
  shareLinkForCaseAssessment: 'Share the following link for users to take assessment',
  scheduleUpdated: '{MRN}\'s schedule has been updated',
  linkAccountWithNewCase: 'Thanks, we\'ve saved your case. This caseID ({caseId}) matches a user\'s secret ID. Do you want to link this account with newly created caseID?',
  selectResponseToReview: 'Please Select a Response to Review'
};
