    ...
    <v-list>
      ...
      <v-list-item @click="moveStart" v-if="canMove">
        ...
        >
          ...
          >
            <v-spacer></v-spacer>
            <v-btn text color="primary" @click="movingDate = false">{{
              labels.pickerCancel
            }}</v-btn>
            <v-btn text color="primary" @click="moveEnd">{{
              labels.pickerOk
            }}</v-btn>
          </v-date-picker>
          ...
          >
            <v-spacer></v-spacer>
            <v-btn color="primary" @click="movingTime = false">{{
              labels.pickerCancel
            }}</v-btn>
            <v-btn color="primary" @click="moveEnd">{{
              labels.pickerOk
            }}</v-btn>
          </v-time-picker>
        </v-menu>
      ...
      <v-list-item @click="includeStart" v-if="canInclude">
        ...
        >
          ...
          >
            <v-spacer></v-spacer>
            <v-btn color="primary" @click="includingDate = false">{{
              labels.pickerCancel
            }}</v-btn>
            <v-btn color="primary" @click="includeEnd">{{
              labels.pickerOk
            }}</v-btn>
          </v-date-picker>
          ...
          >
            <v-spacer></v-spacer>
            <v-btn color="primary" @click="includingTime = false">{{
              labels.pickerCancel
            }}</v-btn>
            <v-btn color="primary" @click="includeEnd">{{
              labels.pickerOk
      ...
      <slot
        name="scheduleActionsAdditional"
        v-bind="{ schedule, calendarEvent, calendar }"
      ></slot>
    </v-list>
  </v-menu>
</template>
