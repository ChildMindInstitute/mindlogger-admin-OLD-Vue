    ...
    <v-list>
      ...
      <v-list-item @click="moveStart" v-if="canMove">
        ...
        >
          ...
          <v-date-picker no-title scrollable v-if="movingDate" v-model="targetDate">
            <v-spacer></v-spacer>
          ...
          <v-time-picker no-title scrollable v-if="movingTime" v-model="targetTime">
            <v-spacer></v-spacer>
      ...
      <v-list-item @click="includeStart" v-if="canInclude">
        ...
        >
          ...
          <v-date-picker no-title scrollable v-if="includingDate" v-model="targetDate">
            <v-spacer></v-spacer>
          ...
          <v-time-picker no-title scrollable v-if="includingTime" v-model="targetTime">
            <v-spacer></v-spacer>
