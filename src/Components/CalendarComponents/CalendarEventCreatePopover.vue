<template>
  <v-card class="ds-calendar-event-popover-card" :class="classes">
    <v-app-bar extended flat :style="styleHeader">
      ...
      <slot name="eventCreatePopoverToolbarLeft" v-bind="slotData" />

      <v-spacer />

      <slot name="eventCreatePopoverToolbarRight" v-bind="slotData" />
      ...
      <slot name="eventCreatePopoverToolbarClose" v-bind="slotData">
        <v-btn icon :style="styleText" @click="close">
          <v-icon>mdi-close</v-icon>
        </v-btn>
      </slot>
    </v-app-bar>
    <v-card-text>
      <slot name="eventCreatePopoverBodyTop" v-bind="slotData" />
      ...
      <slot name="eventCreatePopoverBodyBottom" v-bind="slotData" />
    </v-card-text>

    <slot name="eventCreatePopoverActions" v-bind="slotData" />
  </v-card>
</template>
