  ...
  methods: {
    ...
    mouseDown(mouseEvent) {
      if (this.canAdd && mouseEvent.left) {
        ...
        if (!ev.handled && ev.placeholder) {
          ...
          this.placeholder.event.schedule = Schedule.forTime(
            time,
            time.asTime()
          );
    ...
    mouseMoveDay(mouseEvent) {
      ...
      if (this.moving) {
        ...
        this.placeholder.time.end = day
          .next(this.placeholder.schedule.durationInDays)
          .end();
    ...
    mouseMove(mouseEvent) {
      if (this.adding && mouseEvent.left) {
        ...
        this.placeholder.event.schedule = Schedule.forSpan(
